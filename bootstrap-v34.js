(()=>{
  ...
  (async()=>{
    try{
      ...
      await loadScript('store-v33.js',{timeout:6000,retries:2});
      await loadScript('common-v34.js',{timeout:6000,retries:2});
